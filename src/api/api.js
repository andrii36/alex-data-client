...
const instance = axios.create({
    baseURL: 'https://alex-data-store.herokuapp.com/api',
...
export const api = {
    ...
    getSearchProductsByPartNo(partNumber){
        return instance.get('/products-by-part-number', {params: {partNumber}})
    },
    ...
    purchaseProduct: (id,sellAmount) => {
        return instance.post('/purchase', {}, {params: {id, sellAmount}, 
